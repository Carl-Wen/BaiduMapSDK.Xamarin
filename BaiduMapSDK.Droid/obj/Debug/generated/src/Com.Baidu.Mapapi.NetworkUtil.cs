...
namespace Com.Baidu.Mapapi {
	...
	public partial class NetworkUtil : global::Java.Lang.Object {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapapi']/class[@name='NetworkUtil']/method[@name='isWifiState' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register ("isWifiState", "(Landroid/content/Context;)Z", "")]
		public static unsafe bool IsWifiState (global::Android.Content.Context p0)
		{
			const string __id = "isWifiState.(Landroid/content/Context;)Z";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue ((p0 == null) ? IntPtr.Zero : ((global::Java.Lang.Object) p0).Handle);
				var __rm = _members.StaticMethods.InvokeBooleanMethod (__id, __args);
