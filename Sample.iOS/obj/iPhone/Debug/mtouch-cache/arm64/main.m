...
extern void *mono_aot_module_Sample_iOS_info;
...
extern void *mono_aot_module_Xamarin_Forms_BaiduMaps_iOS_info;
extern void *mono_aot_module_BaiduMapSDK_Base_iOS_info;
extern void *mono_aot_module_Xamarin_Forms_BaiduMaps_info;
extern void *mono_aot_module_BaiduMapSDK_Map_iOS_info;
extern void *mono_aot_module_Sample_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_Sample_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_BaiduMaps_iOS_info);
	mono_aot_register_module (mono_aot_module_BaiduMapSDK_Base_iOS_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_BaiduMaps_info);
	mono_aot_register_module (mono_aot_module_BaiduMapSDK_Map_iOS_info);
	mono_aot_register_module (mono_aot_module_Sample_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("Xamarin.Forms.BaiduMaps.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("BaiduMapSDK.Base.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("BaiduMapSDK.Map.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Sample.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
