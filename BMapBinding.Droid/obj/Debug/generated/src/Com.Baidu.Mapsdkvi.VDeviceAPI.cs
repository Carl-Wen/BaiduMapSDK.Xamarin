...
namespace Com.Baidu.Mapsdkvi {
	...
	public partial class VDeviceAPI : global::Java.Lang.Object {
		...
		public static unsafe string CellId {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapsdkvi']/class[@name='VDeviceAPI']/method[@name='getCellId' and count(parameter)=0]"
			[Register ("getCellId", "()Ljava/lang/String;", "GetGetCellIdHandler")]
			get {
				const string __id = "getCellId.()Ljava/lang/String;";
				try {
					var __rm = _members.StaticMethods.InvokeObjectMethod (__id, null);
					return JNIEnv.GetString (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
		...
		public static unsafe string Imei {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapsdkvi']/class[@name='VDeviceAPI']/method[@name='getImei' and count(parameter)=0]"
		...
		public static unsafe string Imsi {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapsdkvi']/class[@name='VDeviceAPI']/method[@name='getImsi' and count(parameter)=0]"
		...
		public static unsafe string Lac {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapsdkvi']/class[@name='VDeviceAPI']/method[@name='getLac' and count(parameter)=0]"
			[Register ("getLac", "()Ljava/lang/String;", "GetGetLacHandler")]
			get {
				const string __id = "getLac.()Ljava/lang/String;";
				try {
					var __rm = _members.StaticMethods.InvokeObjectMethod (__id, null);
					return JNIEnv.GetString (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapsdkvi']/class[@name='VDeviceAPI']/method[@name='getWifiHotpot' and count(parameter)=0]"
		[Register ("getWifiHotpot", "()[Landroid/net/wifi/ScanResult;", "")]
		public static unsafe global::Android.Net.Wifi.ScanResult[] GetWifiHotpot ()
		{
			const string __id = "getWifiHotpot.()[Landroid/net/wifi/ScanResult;";
			try {
				var __rm = _members.StaticMethods.InvokeObjectMethod (__id, null);
				return (global::Android.Net.Wifi.ScanResult[]) JNIEnv.GetArray (__rm.Handle, JniHandleOwnership.TransferLocalRef, typeof (global::Android.Net.Wifi.ScanResult));
			} finally {
			}
		}
